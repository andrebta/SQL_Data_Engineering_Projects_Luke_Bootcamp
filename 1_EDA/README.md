...
A SQL project analysing the data engineer job market using real world job posting data. It demonstrates my ability to **write production-quality analytical SQL, design efficiente queries, and turn business questions into data-drive insights**
...
2. [`02_top_paying_skills.sql`](./02_top_paying_skills.sql) - salary analysis with agregations
