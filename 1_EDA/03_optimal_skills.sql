/*
Quetion: What are the most optimal skills for data engineers-balancing both demand and salary?
...
SELECT
    ...
    ROUND((MEDIAN(jpf.salary_year_avg) * LN(COUNT(jpf.*))/100000), 2) AS optimal_score
