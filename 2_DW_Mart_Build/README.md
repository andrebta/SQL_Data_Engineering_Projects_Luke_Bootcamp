...
An end-to-end data engineering pipeline that thansforms raw CSV files from Google Cloud Storage into a normalized star schema data warehouse, then build analytical data marts.
