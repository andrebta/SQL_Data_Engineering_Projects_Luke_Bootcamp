...
-- Stage only jobs that are remote vefore agregating to determine the remote median salary per job:
...
-- Kepp only job titles whose median salary is above the overall median:
...
-- Final Example
-- Identify job posting that have no associated skills before loading them into a data mart
