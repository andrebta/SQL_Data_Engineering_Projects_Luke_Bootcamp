...
CREATE OR REPLACE VIEW staging.job_priority_jobs_flat_view AS
SELECT 
    jpf.*
...
SELECT 
    job_title_short,
    COUNT(*) AS job_count
FROM staging.job_priority_jobs_flat_view
...
SELECT COUNT(*) FROM staging.job_priority_jobs_flat_view;
